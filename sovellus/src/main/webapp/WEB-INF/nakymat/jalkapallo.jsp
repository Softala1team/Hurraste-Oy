...
<a href="/sovellus">
<img src="<%=request.getContextPath()%>/resources/images/home3.png" alt="etusivu" style="margin-left:1500px;height:75px;width:70px;padding:3px;border:2px solid white;border-radius:700px;box-shadow:4px 4px 2px 2px black;">
</a>
